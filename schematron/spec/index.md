...
| XPath 3.0 support | [xpath3/](xpath3/index.md) | Phases 1–3: function items, `=>`, `\|\|`, the rest of the higher-order sequence functions |
...
| Rust MSRV policy | [rust-msrv-n-minus-2/](rust-msrv-n-minus-2/index.md) | Implemented |
