...
| XPath 3.0 function items, `=>`, `\|\|`, `for-each()`, `filter`, `fold-left`, `fold-right`, `for-each-pair`, `function-lookup`/`-arity`/`-name` | Subset — see [spec/xpath3/](spec/xpath3/index.md) |
...
| [spec/xpath3/](spec/xpath3/index.md) | The XPath 3.0 subset: function items, `=>`, `\|\|`, the higher-order sequence functions |
